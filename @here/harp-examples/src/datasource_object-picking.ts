 ...
 *
 * For enable line picking set `enableRoadPicking: true` in [[MapViewOptions]] and set
 * `createTileInfo: true` in [[OmvWithRestClientParams|OmvWithCustomDataProvider]].
 * For enable polygon picking set `gatherFeatureIds: true` in
 * [[OmvWithRestClientParams|OmvWithCustomDataProvider]].
 * For enable text element picking set `gatherFeatureIds: true` in
 * [[OmvWithRestClientParams|OmvWithCustomDataProvider]].
 *
